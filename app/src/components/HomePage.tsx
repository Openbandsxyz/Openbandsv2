        ...
        <div className="bg-blue-50 rounded-lg p-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-2">Join Communities</h4>
              <p className="text-gray-600 text-sm">Participate in verified communities with proof-of-membership</p>
            </div>
          </div>
        </div>
      </div>
