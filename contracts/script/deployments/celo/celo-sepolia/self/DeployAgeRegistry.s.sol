...
contract DeployAgeRegistry is Script {
    function run() external {
        ...
        address identityVerificationHub = 0x16ECBA51e18a4a7e61fdC417f0d47AFEeDfbed74;               // @dev - The deployed address of the IdentityVerificationHub contract on Celo Sepolia
        ...
        OpenbandsV2AgeRegistry registry = new OpenbandsV2AgeRegistry(
            ...
            identityVerificationHubOnCeloSepolia,
            scopeSeed
        );
